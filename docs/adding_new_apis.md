...
1. Add an RPC handler which calls your implemented method in [RpcLibServerBase.cpp](https://github.com/microsoft/AirSim/blob/master/AirLib/src/api/RpcLibServerBase.cpp)
...
3. Add the Python API in [client.py](https://github.com/microsoft/AirSim/blob/master/PythonClient/airsim/client.py)

It'll also be good to add some documentation regarding the API, and example scripts if useful to show the working
